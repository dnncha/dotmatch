...
`10.5281/zenodo.22214073`. A version-specific DOI for DotMatch 0.5.0 is
pending Zenodo archival.

Suggested citation:

> O'Toole D. DotMatch: deterministic known-target short-DNA assignment for sequencing workflows. Software release v0.5.0. https://github.com/dnncha/dotmatch

Prior release DOI (v0.4.0): <https://doi.org/10.5281/zenodo.22214073>

Current release DOI (v0.5.0): pending Zenodo archival.
...
Describe DotMatch v0.5.0 as a known-target short-DNA assignment engine. It is
