...
- AssayScript v2 compilation is experimental: it validates multi-read segment
  declarations, fingerprints inputs, selects deterministic strategies, and
  writes portable JSON plans. It is not yet a production universal
  multi-segment runtime;
