...
These results support a narrow short-DNA global edit-distance/threshold-matching story against Edlib's Python binding.
Before claiming state-of-the-art performance, add native C Edlib, SeqAn, and Parasail comparisons where the scoring model is equivalent.
