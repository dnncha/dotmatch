...
these ten wins. Keep private conversations, unmerged PRs, and internal examples
out of public adopter evidence until the rules in `docs/adopters/README.md` are
satisfied.
...
Do not combine these KPIs with performance or correctness claims. Exposure can
increase before external adoption is proven.
